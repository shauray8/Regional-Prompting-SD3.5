        ...
        for index_block, block in enumerate(self.transformer_blocks):
            if self.training and self.gradient_checkpointing:
                ...
                encoder_hidden_states, hidden_states = block(
                    ...
                    image_rotary_emb=image_rotary_emb,
                    image_rotary_emb_base=image_rotary_emb_base,
                    additional_kwargs=additional_kwargs if index_block % joint_attention_kwargs['double_inject_blocks_interval'] == 0 else {k: v for k, v in additional_kwargs.items() if k != 'regional_attention_mask'},
                )
